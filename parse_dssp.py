...
def parse_dssp(dssp_file,args):
        ...
        while line != "":
            ...
            if aa_code != "!":
                ...
                if struct_code in struct_code_list:
                    ...
                    if (struct_code == 'H' or struct_code == 'G' or struct_code == 'I') :
                        classical_s.append('H')
                    elif (struct_code == 'E'):
                        classical_s.append('E')
                    else : 
                        classical_s.append('C')
                elif struct_code == " ":
                    struct_seq += "C"
                    classical_s.append('C')
                else:
                ...
                xlist.append(line[115:122].strip())
                ylist.append(line[122:129].strip())
                zlist.append(line[129:136].strip())
    ...
    dssp_file_parsed = "result/"+ dssp_file[0:4] + "_output_dssp.txt"
    ...
    return aa_pos, chain_ID_seq, aa_seq, struct_seq, phi_list,psi_list,xlist,ylist,zlist,classical_s
